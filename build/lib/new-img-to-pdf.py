...
download_button = tk.Button(mainWindow, text='SAVE PDF', width = 20, height =1,font=('arial',14,'bold'), 
        bg='white',fg='red', command=saveas)
...
download_button_3 = tk.Button(mainWindow, text='SAVE A4 PDF', width = 20, height =1,font=('arial',14,'bold'), 
        bg='white',fg='red', command=saveas3)
download_button_3.grid(row=7, column=0)
download_button_3.place(relx=0.5, rely=0.26, anchor=CENTER)
disable(download_button_3)
...
def open_file(files):
    ...
    if len(files) >= 2 and pdf_download_button['state'] == "disabled":
...
def merge_pdfs(files):
    try:
        ...
        print('Something seems wrong with pdf')
...
# --- Ask open files ---
infoSelectFileLabel = tk.Label(mainWindow, text="Please choose PDFs to join: (2 and above)")
infoSelectFileLabel.grid(row=17, column=0, sticky="ew", padx=5, pady=5)
infoSelectFileLabel.place(relx=0.5, rely=0.6, anchor=CENTER)

#open pdf files one by one
open_singlePdf_button = tk.Button(mainWindow, text="Open PDF(s)", width = 10, height =2,font=('arial',14,'bold'), bg='white',fg='green',
                command=lambda: open_file(fileList))
open_singlePdf_button.place(relx=0.5, rely=0.67, anchor=CENTER)
...
lbl_items = tk.Label(mainWindow, text="")
